...
class TestOrg:
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.audit.org.with_raw_response.retrieve(
            "orgId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.audit.org.with_streaming_response.retrieve(
            "orgId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.audit.org.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncOrg:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        org = await async_client.audit.org.retrieve(
            "orgId",
        )
        assert org is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.audit.org.with_raw_response.retrieve(
            "orgId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.audit.org.with_streaming_response.retrieve(
            "orgId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.audit.org.with_raw_response.retrieve(
                "",
            )
