...
class TestRegions:
    ...
    def test_method_create(self, client: Vaif) -> None:
        region = client.regions.create()
        assert region is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.regions.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.regions.with_streaming_response.create() as response:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        region = client.regions.retrieve(
            "key",
        )
        assert region is None
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.regions.with_raw_response.retrieve(
            "key",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.regions.with_streaming_response.retrieve(
            "key",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `key` but received ''"):
            client.regions.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Vaif) -> None:
        region = client.regions.update(
            "key",
        )
        assert region is None
    ...
    def test_raw_response_update(self, client: Vaif) -> None:
        response = client.regions.with_raw_response.update(
            "key",
        )
    ...
    def test_streaming_response_update(self, client: Vaif) -> None:
        with client.regions.with_streaming_response.update(
            "key",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `key` but received ''"):
            client.regions.with_raw_response.update(
                "",
            )
...
class TestAsyncRegions:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        region = await async_client.regions.create()
        assert region is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.regions.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.regions.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        region = await async_client.regions.retrieve(
            "key",
        )
        assert region is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.regions.with_raw_response.retrieve(
            "key",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.regions.with_streaming_response.retrieve(
            "key",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `key` but received ''"):
            await async_client.regions.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncVaif) -> None:
        region = await async_client.regions.update(
            "key",
        )
        assert region is None
    ...
    async def test_raw_response_update(self, async_client: AsyncVaif) -> None:
        response = await async_client.regions.with_raw_response.update(
            "key",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncVaif) -> None:
        async with async_client.regions.with_streaming_response.update(
            "key",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `key` but received ''"):
            await async_client.regions.with_raw_response.update(
                "",
            )
