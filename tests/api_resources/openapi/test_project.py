...
class TestProject:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        project = client.openapi.project.retrieve(
            "projectId",
        )
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.openapi.project.with_raw_response.retrieve(
            "projectId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.openapi.project.with_streaming_response.retrieve(
            "projectId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.openapi.project.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncProject:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        project = await async_client.openapi.project.retrieve(
            "projectId",
        )
        assert project is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.openapi.project.with_raw_response.retrieve(
            "projectId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.openapi.project.with_streaming_response.retrieve(
            "projectId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.openapi.project.with_raw_response.retrieve(
                "",
            )
