...
class TestExport:
    ...
    def test_method_create(self, client: Vaif) -> None:
        export = client.ai.copilot.export.create(
            "versionId",
        )
    ...
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.ai.copilot.export.with_raw_response.create(
            "versionId",
        )
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.ai.copilot.export.with_streaming_response.create(
            "versionId",
        ) as response:
    ...
    def test_path_params_create(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `version_id` but received ''"):
            client.ai.copilot.export.with_raw_response.create(
                "",
            )
...
class TestAsyncExport:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        export = await async_client.ai.copilot.export.create(
            "versionId",
        )
        assert export is None
    ...
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.export.with_raw_response.create(
            "versionId",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.export.with_streaming_response.create(
            "versionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `version_id` but received ''"):
            await async_client.ai.copilot.export.with_raw_response.create(
                "",
            )
