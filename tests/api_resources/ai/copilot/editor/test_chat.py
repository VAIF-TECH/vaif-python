...
class TestChat:
    ...
    def test_method_create(self, client: Vaif) -> None:
        chat = client.ai.copilot.editor.chat.create(
            message="x",
    ...
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.ai.copilot.editor.chat.with_raw_response.create(
            message="x",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.ai.copilot.editor.chat.with_streaming_response.create(
            message="x",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
...
class TestAsyncChat:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        chat = await async_client.ai.copilot.editor.chat.create(
            message="x",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert chat is None
    ...
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.editor.chat.with_raw_response.create(
            message="x",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.editor.chat.with_streaming_response.create(
            message="x",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
