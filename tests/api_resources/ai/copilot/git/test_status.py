...
class TestStatus:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        status = client.ai.copilot.git.status.retrieve(
            "sessionId",
        )
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.ai.copilot.git.status.with_raw_response.retrieve(
            "sessionId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.ai.copilot.git.status.with_streaming_response.retrieve(
            "sessionId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            client.ai.copilot.git.status.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncStatus:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        status = await async_client.ai.copilot.git.status.retrieve(
            "sessionId",
        )
        assert status is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.git.status.with_raw_response.retrieve(
            "sessionId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.git.status.with_streaming_response.retrieve(
            "sessionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            await async_client.ai.copilot.git.status.with_raw_response.retrieve(
                "",
            )
