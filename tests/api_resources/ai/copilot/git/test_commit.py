...
class TestCommit:
    ...
    def test_method_create(self, client: Vaif) -> None:
        commit = client.ai.copilot.git.commit.create()
        assert commit is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.ai.copilot.git.commit.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.ai.copilot.git.commit.with_streaming_response.create() as response:
...
class TestAsyncCommit:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        commit = await async_client.ai.copilot.git.commit.create()
        assert commit is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.git.commit.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.git.commit.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
