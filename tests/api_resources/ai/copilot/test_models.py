...
class TestModels:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        model = client.ai.copilot.models.retrieve(
            "projectId",
        )
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.ai.copilot.models.with_raw_response.retrieve(
            "projectId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.ai.copilot.models.with_streaming_response.retrieve(
            "projectId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.ai.copilot.models.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncModels:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        model = await async_client.ai.copilot.models.retrieve(
            "projectId",
        )
        assert model is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.models.with_raw_response.retrieve(
            "projectId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.models.with_streaming_response.retrieve(
            "projectId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.ai.copilot.models.with_raw_response.retrieve(
                "",
            )
