...
class TestPause:
    ...
    def test_method_pause(self, client: Vaif) -> None:
        pause = client.ai.copilot.executions.pause.pause(
            "executionId",
        )
    ...
    def test_raw_response_pause(self, client: Vaif) -> None:
        response = client.ai.copilot.executions.pause.with_raw_response.pause(
            "executionId",
        )
    ...
    def test_streaming_response_pause(self, client: Vaif) -> None:
        with client.ai.copilot.executions.pause.with_streaming_response.pause(
            "executionId",
        ) as response:
    ...
    def test_path_params_pause(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `execution_id` but received ''"):
            client.ai.copilot.executions.pause.with_raw_response.pause(
                "",
            )
...
class TestAsyncPause:
    ...
    async def test_method_pause(self, async_client: AsyncVaif) -> None:
        pause = await async_client.ai.copilot.executions.pause.pause(
            "executionId",
        )
        assert pause is None
    ...
    async def test_raw_response_pause(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.executions.pause.with_raw_response.pause(
            "executionId",
        )
    ...
    async def test_streaming_response_pause(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.executions.pause.with_streaming_response.pause(
            "executionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_pause(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `execution_id` but received ''"):
            await async_client.ai.copilot.executions.pause.with_raw_response.pause(
                "",
            )
