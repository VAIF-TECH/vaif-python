...
class TestGitHub:
    ...
    def test_method_create(self, client: Vaif) -> None:
        github = client.ai.copilot.export.github.create()
        assert github is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.ai.copilot.export.github.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.ai.copilot.export.github.with_streaming_response.create() as response:
...
class TestAsyncGitHub:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        github = await async_client.ai.copilot.export.github.create()
        assert github is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai.copilot.export.github.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.ai.copilot.export.github.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
