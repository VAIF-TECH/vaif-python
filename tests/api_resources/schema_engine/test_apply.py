...
class TestApply:
    ...
    def test_method_create(self, client: Vaif) -> None:
        apply = client.schema_engine.apply.create(
            definition={
                "schema_version": "1.0",
                "tables": [
                    {
    ...
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.schema_engine.apply.with_raw_response.create(
            definition={
                "schema_version": "1.0",
                "tables": [
                    {
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.schema_engine.apply.with_streaming_response.create(
            definition={
                "schema_version": "1.0",
                "tables": [
                    {
...
class TestAsyncApply:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        apply = await async_client.schema_engine.apply.create(
            definition={
                "schema_version": "1.0",
                "tables": [
                    {
    ...
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.schema_engine.apply.with_raw_response.create(
            definition={
                "schema_version": "1.0",
                "tables": [
                    {
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.schema_engine.apply.with_streaming_response.create(
            definition={
                "schema_version": "1.0",
                "tables": [
                    {
