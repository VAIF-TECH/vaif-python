...
class TestQuery:
    ...
    def test_method_create(self, client: Vaif) -> None:
        query = client.schema_engine.query.create(
    ...
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.schema_engine.query.with_raw_response.create(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sql="x",
        )
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.schema_engine.query.with_streaming_response.create(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sql="x",
        ) as response:
    ...
    def test_path_params_create(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.schema_engine.query.with_raw_response.create(
                project_id="",
                sql="x",
            )
...
class TestAsyncQuery:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        query = await async_client.schema_engine.query.create(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sql="x",
        )
        assert_matches_type(QueryCreateResponse, query, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.schema_engine.query.with_raw_response.create(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sql="x",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.schema_engine.query.with_streaming_response.create(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sql="x",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.schema_engine.query.with_raw_response.create(
                project_id="",
                sql="x",
            )
