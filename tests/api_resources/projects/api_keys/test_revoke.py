...
class TestRevoke:
    ...
    def test_method_revoke(self, client: Vaif) -> None:
        revoke = client.projects.api_keys.revoke.revoke(
            key_id="keyId",
    ...
    def test_raw_response_revoke(self, client: Vaif) -> None:
        response = client.projects.api_keys.revoke.with_raw_response.revoke(
            key_id="keyId",
            project_id="projectId",
        )
    ...
    def test_streaming_response_revoke(self, client: Vaif) -> None:
        with client.projects.api_keys.revoke.with_streaming_response.revoke(
            key_id="keyId",
            project_id="projectId",
        ) as response:
    ...
    def test_path_params_revoke(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.projects.api_keys.revoke.with_raw_response.revoke(
                key_id="keyId",
                project_id="",
            )
...
class TestAsyncRevoke:
    ...
    async def test_method_revoke(self, async_client: AsyncVaif) -> None:
        revoke = await async_client.projects.api_keys.revoke.revoke(
            key_id="keyId",
            project_id="projectId",
        )
        assert revoke is None
    ...
    async def test_raw_response_revoke(self, async_client: AsyncVaif) -> None:
        response = await async_client.projects.api_keys.revoke.with_raw_response.revoke(
            key_id="keyId",
            project_id="projectId",
        )
    ...
    async def test_streaming_response_revoke(self, async_client: AsyncVaif) -> None:
        async with async_client.projects.api_keys.revoke.with_streaming_response.revoke(
            key_id="keyId",
            project_id="projectId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_revoke(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.projects.api_keys.revoke.with_raw_response.revoke(
                key_id="keyId",
                project_id="",
            )
