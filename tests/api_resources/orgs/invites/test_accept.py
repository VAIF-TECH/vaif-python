...
class TestAccept:
    ...
    def test_method_create(self, client: Vaif) -> None:
        accept = client.orgs.invites.accept.create()
        assert accept is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.orgs.invites.accept.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.orgs.invites.accept.with_streaming_response.create() as response:
...
class TestAsyncAccept:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        accept = await async_client.orgs.invites.accept.create()
        assert accept is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.orgs.invites.accept.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.orgs.invites.accept.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
