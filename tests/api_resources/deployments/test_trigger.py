...
class TestTrigger:
    ...
    def test_method_create(self, client: Vaif) -> None:
        trigger = client.deployments.trigger.create()
        assert trigger is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.deployments.trigger.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.deployments.trigger.with_streaming_response.create() as response:
...
class TestAsyncTrigger:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        trigger = await async_client.deployments.trigger.create()
        assert trigger is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.deployments.trigger.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.deployments.trigger.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
