...
class TestHistory:
    ...
    def test_method_get_history(self, client: Vaif) -> None:
        history = client.ai_usage.org.history.get_history(
            "orgId",
        )
    ...
    def test_raw_response_get_history(self, client: Vaif) -> None:
        response = client.ai_usage.org.history.with_raw_response.get_history(
            "orgId",
        )
    ...
    def test_streaming_response_get_history(self, client: Vaif) -> None:
        with client.ai_usage.org.history.with_streaming_response.get_history(
            "orgId",
        ) as response:
    ...
    def test_path_params_get_history(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.ai_usage.org.history.with_raw_response.get_history(
                "",
            )
...
class TestAsyncHistory:
    ...
    async def test_method_get_history(self, async_client: AsyncVaif) -> None:
        history = await async_client.ai_usage.org.history.get_history(
            "orgId",
        )
        assert history is None
    ...
    async def test_raw_response_get_history(self, async_client: AsyncVaif) -> None:
        response = await async_client.ai_usage.org.history.with_raw_response.get_history(
            "orgId",
        )
    ...
    async def test_streaming_response_get_history(self, async_client: AsyncVaif) -> None:
        async with async_client.ai_usage.org.history.with_streaming_response.get_history(
            "orgId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_history(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.ai_usage.org.history.with_raw_response.get_history(
                "",
            )
