...
class TestQuery:
    ...
    def test_method_query(self, client: Vaif) -> None:
        query = client.generated.query.query(
            "table",
        )
    ...
    def test_raw_response_query(self, client: Vaif) -> None:
        response = client.generated.query.with_raw_response.query(
            "table",
        )
    ...
    def test_streaming_response_query(self, client: Vaif) -> None:
        with client.generated.query.with_streaming_response.query(
            "table",
        ) as response:
    ...
    def test_path_params_query(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table` but received ''"):
            client.generated.query.with_raw_response.query(
                "",
            )
...
class TestAsyncQuery:
    ...
    async def test_method_query(self, async_client: AsyncVaif) -> None:
        query = await async_client.generated.query.query(
            "table",
        )
        assert query is None
    ...
    async def test_raw_response_query(self, async_client: AsyncVaif) -> None:
        response = await async_client.generated.query.with_raw_response.query(
            "table",
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncVaif) -> None:
        async with async_client.generated.query.with_streaming_response.query(
            "table",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_query(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table` but received ''"):
            await async_client.generated.query.with_raw_response.query(
                "",
            )
