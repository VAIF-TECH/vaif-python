...
class TestCallback:
    ...
    def test_method_list(self, client: Vaif) -> None:
        callback = client.github.oauth.callback.list()
        assert callback is None

    @parametrize
    def test_raw_response_list(self, client: Vaif) -> None:
        response = client.github.oauth.callback.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Vaif) -> None:
        with client.github.oauth.callback.with_streaming_response.list() as response:
...
class TestAsyncCallback:
    ...
    async def test_method_list(self, async_client: AsyncVaif) -> None:
        callback = await async_client.github.oauth.callback.list()
        assert callback is None

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncVaif) -> None:
        response = await async_client.github.oauth.callback.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncVaif) -> None:
        async with async_client.github.oauth.callback.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
