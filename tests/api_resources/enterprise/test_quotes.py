...
class TestQuotes:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        quote = client.enterprise.quotes.retrieve(
            "quoteId",
        )
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.enterprise.quotes.with_raw_response.retrieve(
            "quoteId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.enterprise.quotes.with_streaming_response.retrieve(
            "quoteId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `quote_id` but received ''"):
            client.enterprise.quotes.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncQuotes:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        quote = await async_client.enterprise.quotes.retrieve(
            "quoteId",
        )
        assert quote is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.enterprise.quotes.with_raw_response.retrieve(
            "quoteId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.enterprise.quotes.with_streaming_response.retrieve(
            "quoteId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `quote_id` but received ''"):
            await async_client.enterprise.quotes.with_raw_response.retrieve(
                "",
            )
