...
class TestCopy:
    ...
    def test_method_create(self, client: Vaif) -> None:
        copy = client.storage.files.copy.create()
        assert copy is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.storage.files.copy.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.storage.files.copy.with_streaming_response.create() as response:
...
class TestAsyncCopy:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        copy = await async_client.storage.files.copy.create()
        assert copy is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.storage.files.copy.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.storage.files.copy.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
