...
class TestRefresh:
    ...
    def test_method_create(self, client: Vaif) -> None:
        refresh = client.auth.refresh.create()
        assert_matches_type(RefreshCreateResponse, refresh, path=["response"])

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.auth.refresh.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.auth.refresh.with_streaming_response.create() as response:
...
class TestAsyncRefresh:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        refresh = await async_client.auth.refresh.create()
        assert_matches_type(RefreshCreateResponse, refresh, path=["response"])

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.auth.refresh.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.auth.refresh.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
