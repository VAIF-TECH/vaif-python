...
class TestLogin:
    ...
    def test_method_create(self, client: Vaif) -> None:
        login = client.auth.cli.login.create(
            email="dev@stainless.com",
            password="xxxxxxxx",
        )
        assert_matches_type(LoginCreateResponse, login, path=["response"])

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.auth.cli.login.with_raw_response.create(
            email="dev@stainless.com",
            password="xxxxxxxx",
        )
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.auth.cli.login.with_streaming_response.create(
            email="dev@stainless.com",
            password="xxxxxxxx",
        ) as response:
...
class TestAsyncLogin:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        login = await async_client.auth.cli.login.create(
            email="dev@stainless.com",
            password="xxxxxxxx",
        )
        assert_matches_type(LoginCreateResponse, login, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.auth.cli.login.with_raw_response.create(
            email="dev@stainless.com",
            password="xxxxxxxx",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.auth.cli.login.with_streaming_response.create(
            email="dev@stainless.com",
            password="xxxxxxxx",
        ) as response:
            assert not response.is_closed
