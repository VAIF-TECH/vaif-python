...
class TestApply:
    ...
    def test_method_create(self, client: Vaif) -> None:
        apply = client.templates.install.apply.create()
        assert apply is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.templates.install.apply.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.templates.install.apply.with_streaming_response.create() as response:
...
class TestAsyncApply:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        apply = await async_client.templates.install.apply.create()
        assert apply is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.templates.install.apply.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.templates.install.apply.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
