...
class TestSDKs:
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.docs.sdks.with_raw_response.retrieve(
            "platform",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.docs.sdks.with_streaming_response.retrieve(
            "platform",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `platform` but received ''"):
            client.docs.sdks.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Vaif) -> None:
        sdk = client.docs.sdks.list()
        assert sdk is None

    @parametrize
    def test_raw_response_list(self, client: Vaif) -> None:
        response = client.docs.sdks.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Vaif) -> None:
        with client.docs.sdks.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSDKs:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        sdk = await async_client.docs.sdks.retrieve(
            "platform",
        )
        assert sdk is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.sdks.with_raw_response.retrieve(
            "platform",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.sdks.with_streaming_response.retrieve(
            "platform",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `platform` but received ''"):
            await async_client.docs.sdks.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncVaif) -> None:
        sdk = await async_client.docs.sdks.list()
        assert sdk is None

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.sdks.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.sdks.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
