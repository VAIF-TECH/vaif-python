...
class TestChangelog:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        changelog = client.docs.changelog.retrieve(
            "id",
        )
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.docs.changelog.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.docs.changelog.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.docs.changelog.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Vaif) -> None:
        changelog = client.docs.changelog.list()
        assert changelog is None

    @parametrize
    def test_raw_response_list(self, client: Vaif) -> None:
        response = client.docs.changelog.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Vaif) -> None:
        with client.docs.changelog.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncChangelog:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        changelog = await async_client.docs.changelog.retrieve(
            "id",
        )
        assert changelog is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.changelog.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.changelog.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.docs.changelog.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncVaif) -> None:
        changelog = await async_client.docs.changelog.list()
        assert changelog is None

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.changelog.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.changelog.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
