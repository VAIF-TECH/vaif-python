...
class TestExamples:
    ...
    def test_method_retrieve(self, client: Vaif) -> None:
        example = client.docs.examples.retrieve(
            "slug",
        )
    ...
    def test_raw_response_retrieve(self, client: Vaif) -> None:
        response = client.docs.examples.with_raw_response.retrieve(
            "slug",
        )
    ...
    def test_streaming_response_retrieve(self, client: Vaif) -> None:
        with client.docs.examples.with_streaming_response.retrieve(
            "slug",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.docs.examples.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Vaif) -> None:
        example = client.docs.examples.list()
        assert example is None

    @parametrize
    def test_raw_response_list(self, client: Vaif) -> None:
        response = client.docs.examples.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Vaif) -> None:
        with client.docs.examples.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncExamples:
    ...
    async def test_method_retrieve(self, async_client: AsyncVaif) -> None:
        example = await async_client.docs.examples.retrieve(
            "slug",
        )
        assert example is None
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.examples.with_raw_response.retrieve(
            "slug",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.examples.with_streaming_response.retrieve(
            "slug",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.docs.examples.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncVaif) -> None:
        example = await async_client.docs.examples.list()
        assert example is None

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.examples.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.examples.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
