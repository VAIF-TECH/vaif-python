...
class TestCategories:
    ...
    def test_method_list(self, client: Vaif) -> None:
        category = client.docs.categories.list()
        assert category is None

    @parametrize
    def test_raw_response_list(self, client: Vaif) -> None:
        response = client.docs.categories.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Vaif) -> None:
        with client.docs.categories.with_streaming_response.list() as response:
...
class TestAsyncCategories:
    ...
    async def test_method_list(self, async_client: AsyncVaif) -> None:
        category = await async_client.docs.categories.list()
        assert category is None

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncVaif) -> None:
        response = await async_client.docs.categories.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncVaif) -> None:
        async with async_client.docs.categories.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
