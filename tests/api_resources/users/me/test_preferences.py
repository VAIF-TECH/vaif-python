...
class TestPreferences:
    ...
    def test_method_list(self, client: Vaif) -> None:
        preference = client.users.me.preferences.list()
        assert preference is None

    @parametrize
    def test_raw_response_list(self, client: Vaif) -> None:
        response = client.users.me.preferences.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Vaif) -> None:
        with client.users.me.preferences.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPreferences:
    ...
    async def test_method_list(self, async_client: AsyncVaif) -> None:
        preference = await async_client.users.me.preferences.list()
        assert preference is None

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncVaif) -> None:
        response = await async_client.users.me.preferences.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncVaif) -> None:
        async with async_client.users.me.preferences.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
