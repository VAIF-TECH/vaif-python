...
class TestValue:
    ...
    def test_method_get_value(self, client: Vaif) -> None:
        value = client.functions.secrets.value.get_value(
            "secretId",
        )
    ...
    def test_raw_response_get_value(self, client: Vaif) -> None:
        response = client.functions.secrets.value.with_raw_response.get_value(
            "secretId",
        )
    ...
    def test_streaming_response_get_value(self, client: Vaif) -> None:
        with client.functions.secrets.value.with_streaming_response.get_value(
            "secretId",
        ) as response:
    ...
    def test_path_params_get_value(self, client: Vaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `secret_id` but received ''"):
            client.functions.secrets.value.with_raw_response.get_value(
                "",
            )
...
class TestAsyncValue:
    ...
    async def test_method_get_value(self, async_client: AsyncVaif) -> None:
        value = await async_client.functions.secrets.value.get_value(
            "secretId",
        )
        assert value is None
    ...
    async def test_raw_response_get_value(self, async_client: AsyncVaif) -> None:
        response = await async_client.functions.secrets.value.with_raw_response.get_value(
            "secretId",
        )
    ...
    async def test_streaming_response_get_value(self, async_client: AsyncVaif) -> None:
        async with async_client.functions.secrets.value.with_streaming_response.get_value(
            "secretId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_value(self, async_client: AsyncVaif) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `secret_id` but received ''"):
            await async_client.functions.secrets.value.with_raw_response.get_value(
                "",
            )
