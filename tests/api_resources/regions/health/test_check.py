...
class TestCheck:
    ...
    def test_method_create(self, client: Vaif) -> None:
        check = client.regions.health.check.create()
        assert check is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.regions.health.check.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.regions.health.check.with_streaming_response.create() as response:
...
class TestAsyncCheck:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        check = await async_client.regions.health.check.create()
        assert check is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.regions.health.check.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.regions.health.check.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
