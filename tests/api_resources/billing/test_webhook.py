...
class TestWebhook:
    ...
    def test_method_create(self, client: Vaif) -> None:
        webhook = client.billing.webhook.create()
        assert webhook is None

    @parametrize
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.billing.webhook.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.billing.webhook.with_streaming_response.create() as response:
...
class TestAsyncWebhook:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        webhook = await async_client.billing.webhook.create()
        assert webhook is None

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.billing.webhook.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.billing.webhook.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
