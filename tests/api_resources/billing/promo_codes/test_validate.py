...
class TestValidate:
    ...
    def test_method_create(self, client: Vaif) -> None:
        validate = client.billing.promo_codes.validate.create(
            code="x",
        )
    ...
    def test_raw_response_create(self, client: Vaif) -> None:
        response = client.billing.promo_codes.validate.with_raw_response.create(
            code="x",
        )
    ...
    def test_streaming_response_create(self, client: Vaif) -> None:
        with client.billing.promo_codes.validate.with_streaming_response.create(
            code="x",
        ) as response:
...
class TestAsyncValidate:
    ...
    async def test_method_create(self, async_client: AsyncVaif) -> None:
        validate = await async_client.billing.promo_codes.validate.create(
            code="x",
        )
        assert_matches_type(ValidateCreateResponse, validate, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncVaif) -> None:
        response = await async_client.billing.promo_codes.validate.with_raw_response.create(
            code="x",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncVaif) -> None:
        async with async_client.billing.promo_codes.validate.with_streaming_response.create(
            code="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
