...
from ....types.integrations.dlq.project_retrieve_response import ProjectRetrieveResponse
...
class ProjectResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/integrations/dlq/project/{project_id}", project_id=project_id),
