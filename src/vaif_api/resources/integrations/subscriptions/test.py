...
from ....types.integrations.subscriptions.test_test_response import TestTestResponse
...
class TestResource(SyncAPIResource):
    ...
    def test(
        ...
        *,
        ...
        return self._post(
            path_template("/integrations/subscriptions/{id}/test", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=TestTestResponse,
        )
