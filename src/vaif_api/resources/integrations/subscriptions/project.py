...
from ....types.integrations.subscriptions.project_retrieve_response import ProjectRetrieveResponse
...
class ProjectResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/integrations/subscriptions/project/{project_id}", project_id=project_id),
