...
class OrgResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/credits/org/{org_id}", org_id=org_id),
...
class OrgResourceWithRawResponse:
    ...
    def balance(self) -> BalanceResourceWithRawResponse:
        return BalanceResourceWithRawResponse(self._org.balance)
...
class AsyncOrgResourceWithRawResponse:
    ...
    def balance(self) -> AsyncBalanceResourceWithRawResponse:
        return AsyncBalanceResourceWithRawResponse(self._org.balance)
...
class OrgResourceWithStreamingResponse:
    ...
    def balance(self) -> BalanceResourceWithStreamingResponse:
        return BalanceResourceWithStreamingResponse(self._org.balance)
...
class AsyncOrgResourceWithStreamingResponse:
    ...
    def balance(self) -> AsyncBalanceResourceWithStreamingResponse:
        return AsyncBalanceResourceWithStreamingResponse(self._org.balance)
