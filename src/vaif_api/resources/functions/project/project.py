...
class ProjectResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/functions/project/{project_id}", project_id=project_id),
...
class ProjectResourceWithRawResponse:
    ...
    def name(self) -> NameResourceWithRawResponse:
        return NameResourceWithRawResponse(self._project.name)
...
class AsyncProjectResourceWithRawResponse:
    ...
    def name(self) -> AsyncNameResourceWithRawResponse:
        return AsyncNameResourceWithRawResponse(self._project.name)
...
class ProjectResourceWithStreamingResponse:
    ...
    def name(self) -> NameResourceWithStreamingResponse:
        return NameResourceWithStreamingResponse(self._project.name)
...
class AsyncProjectResourceWithStreamingResponse:
    ...
    def name(self) -> AsyncNameResourceWithStreamingResponse:
        return AsyncNameResourceWithStreamingResponse(self._project.name)
