...
__all__ = ["JobCreateParams", "Attachment", "GenerationOptions"]
...
class JobCreateParams(TypedDict, total=False):
    ...
    resume_from_checkpoint: Annotated[str, PropertyInfo(alias="resumeFromCheckpoint")]

    resume_from_execution: Annotated[str, PropertyInfo(alias="resumeFromExecution")]
