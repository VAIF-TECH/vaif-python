...
class ProjectResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/metrics/project/{project_id}", project_id=project_id),
...
class ProjectResourceWithRawResponse:
    ...
    def overview(self) -> OverviewResourceWithRawResponse:
        return OverviewResourceWithRawResponse(self._project.overview)
...
class AsyncProjectResourceWithRawResponse:
    ...
    def overview(self) -> AsyncOverviewResourceWithRawResponse:
        return AsyncOverviewResourceWithRawResponse(self._project.overview)
...
class ProjectResourceWithStreamingResponse:
    ...
    def overview(self) -> OverviewResourceWithStreamingResponse:
        return OverviewResourceWithStreamingResponse(self._project.overview)
...
class AsyncProjectResourceWithStreamingResponse:
    ...
    def overview(self) -> AsyncOverviewResourceWithStreamingResponse:
        return AsyncOverviewResourceWithStreamingResponse(self._project.overview)
