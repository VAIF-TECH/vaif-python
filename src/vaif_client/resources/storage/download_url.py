...
from ...types.storage import download_url_create_params
from ...types.storage.download_url_create_response import DownloadURLCreateResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                download_url_create_params.DownloadURLCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DownloadURLCreateResponse,
        )
