...
from ....types.billing.promo_codes import validate_create_params
from ....types.billing.promo_codes.validate_create_response import ValidateCreateResponse
...
class ValidateResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        code: str,
        plan: Literal["starter", "pro", "agency", "studio_plus"] | Omit = omit,
