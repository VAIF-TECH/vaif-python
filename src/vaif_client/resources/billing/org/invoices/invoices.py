...
class InvoicesResource(SyncAPIResource):
    ...
    def get_invoices(
        ...
        *,
        ...
        return self._get(
            path_template("/billing/org/{org_id}/invoices", org_id=org_id),
...
class InvoicesResourceWithRawResponse:
    def __init__(self, invoices: InvoicesResource) -> None:
        ...
        self.get_invoices = to_raw_response_wrapper(
            invoices.get_invoices,
        )

    @cached_property
    def pdf(self) -> PdfResourceWithRawResponse:
        return PdfResourceWithRawResponse(self._invoices.pdf)
...
class AsyncInvoicesResourceWithRawResponse:
    def __init__(self, invoices: AsyncInvoicesResource) -> None:
        ...
        self.get_invoices = async_to_raw_response_wrapper(
            invoices.get_invoices,
        )

    @cached_property
    def pdf(self) -> AsyncPdfResourceWithRawResponse:
        return AsyncPdfResourceWithRawResponse(self._invoices.pdf)
...
class InvoicesResourceWithStreamingResponse:
    def __init__(self, invoices: InvoicesResource) -> None:
        ...
        self.get_invoices = to_streamed_response_wrapper(
            invoices.get_invoices,
        )

    @cached_property
    def pdf(self) -> PdfResourceWithStreamingResponse:
        return PdfResourceWithStreamingResponse(self._invoices.pdf)
...
class AsyncInvoicesResourceWithStreamingResponse:
    def __init__(self, invoices: AsyncInvoicesResource) -> None:
        ...
        self.get_invoices = async_to_streamed_response_wrapper(
            invoices.get_invoices,
        )

    @cached_property
    def pdf(self) -> AsyncPdfResourceWithStreamingResponse:
        return AsyncPdfResourceWithStreamingResponse(self._invoices.pdf)
