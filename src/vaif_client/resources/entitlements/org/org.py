...
class OrgResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/entitlements/org/{org_id}", org_id=org_id),
...
class OrgResourceWithRawResponse:
    ...
    def check(self) -> CheckResourceWithRawResponse:
        return CheckResourceWithRawResponse(self._org.check)
...
class AsyncOrgResourceWithRawResponse:
    ...
    def check(self) -> AsyncCheckResourceWithRawResponse:
        return AsyncCheckResourceWithRawResponse(self._org.check)
...
class OrgResourceWithStreamingResponse:
    ...
    def check(self) -> CheckResourceWithStreamingResponse:
        return CheckResourceWithStreamingResponse(self._org.check)
...
class AsyncOrgResourceWithStreamingResponse:
    ...
    def check(self) -> AsyncCheckResourceWithStreamingResponse:
        return AsyncCheckResourceWithStreamingResponse(self._org.check)
