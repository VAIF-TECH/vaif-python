...
class ExamplesResource(SyncAPIResource):
    ...
    def get_examples(
        ...
        *,
        ...
        """
        if not sdk_id:
            raise ValueError(f"Expected a non-empty value for `sdk_id` but received {sdk_id!r}")
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._get(
            path_template("/docs/sdks/{sdk_id}/examples", sdk_id=sdk_id),
...
class ExamplesResourceWithRawResponse:
    def __init__(self, examples: ExamplesResource) -> None:
        ...
        self.get_examples = to_raw_response_wrapper(
...
class AsyncExamplesResourceWithRawResponse:
    def __init__(self, examples: AsyncExamplesResource) -> None:
        ...
        self.get_examples = async_to_raw_response_wrapper(
            examples.get_examples,
        )
...
class ExamplesResourceWithStreamingResponse:
    def __init__(self, examples: ExamplesResource) -> None:
        ...
        self.get_examples = to_streamed_response_wrapper(
            examples.get_examples,
        )
...
class AsyncExamplesResourceWithStreamingResponse:
    def __init__(self, examples: AsyncExamplesResource) -> None:
        ...
        self.get_examples = async_to_streamed_response_wrapper(
            examples.get_examples,
        )
