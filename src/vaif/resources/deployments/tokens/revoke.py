...
from ....types.deployments.tokens.revoke_revoke_response import RevokeRevokeResponse
...
class RevokeResource(SyncAPIResource):
    ...
    def revoke(
        ...
        *,
        ...
        return self._post(
            path_template("/deployments/tokens/{token_id}/revoke", token_id=token_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RevokeRevokeResponse,
        )
