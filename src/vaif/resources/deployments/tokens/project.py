...
from ....types.deployments.tokens.project_retrieve_response import ProjectRetrieveResponse
...
class ProjectResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/deployments/tokens/project/{project_id}", project_id=project_id),
