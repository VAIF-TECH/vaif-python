...
from ...types.incidents.resolve_resolve_response import ResolveResolveResponse
...
class ResolveResource(SyncAPIResource):
    ...
    def resolve(
        ...
        *,
        ...
        return self._post(
            path_template("/incidents/{incident_id}/resolve", incident_id=incident_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ResolveResolveResponse,
        )
