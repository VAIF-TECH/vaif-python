...
class AddonsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/billing/org/{org_id}/addons/{addon_id}", org_id=org_id, addon_id=addon_id),
    ...
    def addons(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            path_template("/billing/org/{org_id}/addons", org_id=org_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AddonsResourceWithRawResponse:
    def __init__(self, addons: AddonsResource) -> None:
        ...
        self.addons = to_raw_response_wrapper(
            addons.addons,
        )
        self.get_addons = to_raw_response_wrapper(
            addons.get_addons,
        )
...
class AsyncAddonsResourceWithRawResponse:
    def __init__(self, addons: AsyncAddonsResource) -> None:
        ...
        self.addons = async_to_raw_response_wrapper(
            addons.addons,
        )
        self.get_addons = async_to_raw_response_wrapper(
            addons.get_addons,
        )
...
class AddonsResourceWithStreamingResponse:
    def __init__(self, addons: AddonsResource) -> None:
        ...
        self.addons = to_streamed_response_wrapper(
            addons.addons,
        )
        self.get_addons = to_streamed_response_wrapper(
            addons.get_addons,
        )
...
class AsyncAddonsResourceWithStreamingResponse:
    def __init__(self, addons: AsyncAddonsResource) -> None:
        ...
        self.addons = async_to_streamed_response_wrapper(
            addons.addons,
        )
        self.get_addons = async_to_streamed_response_wrapper(
            addons.get_addons,
        )
