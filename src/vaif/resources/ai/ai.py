...
class AIResourceWithRawResponse:
    ...
    def copilot(self) -> CopilotResourceWithRawResponse:
        return CopilotResourceWithRawResponse(self._ai.copilot)
...
class AsyncAIResourceWithRawResponse:
    ...
    def copilot(self) -> AsyncCopilotResourceWithRawResponse:
        return AsyncCopilotResourceWithRawResponse(self._ai.copilot)
...
class AIResourceWithStreamingResponse:
    ...
    def copilot(self) -> CopilotResourceWithStreamingResponse:
        return CopilotResourceWithStreamingResponse(self._ai.copilot)
...
class AsyncAIResourceWithStreamingResponse:
    ...
    def copilot(self) -> AsyncCopilotResourceWithStreamingResponse:
        return AsyncCopilotResourceWithStreamingResponse(self._ai.copilot)
