...
from ....types.ai.copilot import feedback_create_params
from ....types.ai.copilot.feedback_create_response import FeedbackCreateResponse
...
class FeedbackResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        feedback_type: Literal["correct", "incorrect", "partial"],
        message_id: str,
        session_id: str,
        corrected_intent: str | Omit = omit,
        user_feedback: str | Omit = omit,
