...
class OAuthResourceWithRawResponse:
    ...
    def authorize(self) -> AuthorizeResourceWithRawResponse:
        return AuthorizeResourceWithRawResponse(self._oauth.authorize)
...
class AsyncOAuthResourceWithRawResponse:
    ...
    def authorize(self) -> AsyncAuthorizeResourceWithRawResponse:
        return AsyncAuthorizeResourceWithRawResponse(self._oauth.authorize)
...
class OAuthResourceWithStreamingResponse:
    ...
    def authorize(self) -> AuthorizeResourceWithStreamingResponse:
        return AuthorizeResourceWithStreamingResponse(self._oauth.authorize)
...
class AsyncOAuthResourceWithStreamingResponse:
    ...
    def authorize(self) -> AsyncAuthorizeResourceWithStreamingResponse:
        return AsyncAuthorizeResourceWithStreamingResponse(self._oauth.authorize)
