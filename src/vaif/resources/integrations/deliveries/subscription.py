...
from ....types.integrations.deliveries.subscription_retrieve_response import SubscriptionRetrieveResponse
...
class SubscriptionResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/integrations/deliveries/subscription/{subscription_id}", subscription_id=subscription_id),
