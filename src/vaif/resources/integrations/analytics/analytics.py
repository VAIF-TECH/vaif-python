...
class AnalyticsResourceWithRawResponse:
    ...
    def project(self) -> ProjectResourceWithRawResponse:
        return ProjectResourceWithRawResponse(self._analytics.project)
...
class AsyncAnalyticsResourceWithRawResponse:
    ...
    def project(self) -> AsyncProjectResourceWithRawResponse:
        return AsyncProjectResourceWithRawResponse(self._analytics.project)
...
class AnalyticsResourceWithStreamingResponse:
    ...
    def project(self) -> ProjectResourceWithStreamingResponse:
        return ProjectResourceWithStreamingResponse(self._analytics.project)
...
class AsyncAnalyticsResourceWithStreamingResponse:
    ...
    def project(self) -> AsyncProjectResourceWithStreamingResponse:
        return AsyncProjectResourceWithStreamingResponse(self._analytics.project)
