...
from ....types.storage.multipart import complete_complete_params
from ....types.storage.multipart.complete_complete_response import CompleteCompleteResponse
...
class CompleteResource(SyncAPIResource):
    ...
    def complete(
        ...
        *,
        bucket_id: str,
        key: str,
        parts: Iterable[complete_complete_params.Part],
        ...
        return self._post(
            path_template("/storage/multipart/{upload_id}/complete", upload_id=upload_id),
            body=maybe_transform(
                ...
                complete_complete_params.CompleteCompleteParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CompleteCompleteResponse,
        )
