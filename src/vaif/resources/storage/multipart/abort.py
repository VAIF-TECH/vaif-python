...
from ....types.storage.multipart import abort_abort_params
from ....types.storage.multipart.abort_abort_response import AbortAbortResponse
...
class AbortResource(SyncAPIResource):
    ...
    def abort(
        ...
        *,
        ...
        return self._post(
            path_template("/storage/multipart/{upload_id}/abort", upload_id=upload_id),
            body=maybe_transform(
                {
                    "bucket_id": bucket_id,
                    "key": key,
                },
                abort_abort_params.AbortAbortParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AbortAbortResponse,
        )
