...
from .....types.oauth.org.provider.refresh_refresh_response import RefreshRefreshResponse
...
class RefreshResource(SyncAPIResource):
    ...
    def refresh(
        ...
        *,
        ...
        return self._post(
            path_template("/oauth/org/{org_id}/provider/{provider}/refresh", org_id=org_id, provider=provider),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RefreshRefreshResponse,
        )
