...
from .....types.oauth.org.provider.authorize_get_authorize_response import AuthorizeGetAuthorizeResponse
...
class AuthorizeResource(SyncAPIResource):
    ...
    def get_authorize(
        ...
        *,
        ...
        return self._get(
            path_template("/oauth/org/{org_id}/provider/{provider}/authorize", org_id=org_id, provider=provider),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AuthorizeGetAuthorizeResponse,
        )
...
class AuthorizeResourceWithRawResponse:
    def __init__(self, authorize: AuthorizeResource) -> None:
        ...
        self.get_authorize = to_raw_response_wrapper(
...
class AsyncAuthorizeResourceWithRawResponse:
    def __init__(self, authorize: AsyncAuthorizeResource) -> None:
        ...
        self.get_authorize = async_to_raw_response_wrapper(
            authorize.get_authorize,
        )
...
class AuthorizeResourceWithStreamingResponse:
    def __init__(self, authorize: AuthorizeResource) -> None:
        ...
        self.get_authorize = to_streamed_response_wrapper(
            authorize.get_authorize,
        )
...
class AsyncAuthorizeResourceWithStreamingResponse:
    def __init__(self, authorize: AsyncAuthorizeResource) -> None:
        ...
        self.get_authorize = async_to_streamed_response_wrapper(
            authorize.get_authorize,
        )
