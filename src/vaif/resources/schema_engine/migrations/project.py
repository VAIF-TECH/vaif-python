...
from ....types.schema_engine.migrations.project_retrieve_response import ProjectRetrieveResponse
...
class ProjectResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/schema-engine/migrations/project/{project_id}", project_id=project_id),
