...
from ...types.docs import ai_answer_create_params
...
class AIAnswerResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        context: str,
        question: str,
        conversation_history: Iterable[ai_answer_create_params.ConversationHistory] | Omit = omit,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                ai_answer_create_params.AIAnswerCreateParams,
            ),
