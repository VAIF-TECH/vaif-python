...
class LogsResourceWithRawResponse:
    ...
    def project(self) -> ProjectResourceWithRawResponse:
        return ProjectResourceWithRawResponse(self._logs.project)
...
class AsyncLogsResourceWithRawResponse:
    ...
    def project(self) -> AsyncProjectResourceWithRawResponse:
        return AsyncProjectResourceWithRawResponse(self._logs.project)
...
class LogsResourceWithStreamingResponse:
    ...
    def project(self) -> ProjectResourceWithStreamingResponse:
        return ProjectResourceWithStreamingResponse(self._logs.project)
...
class AsyncLogsResourceWithStreamingResponse:
    ...
    def project(self) -> AsyncProjectResourceWithStreamingResponse:
        return AsyncProjectResourceWithStreamingResponse(self._logs.project)
